...
def C_Source_NCAT_Set(cfg, SourceWeights = None,NumberOfSubSources = None): 
    print('Setting the source info for an NCAT phantom in C global variables.')
    #cfgnew = cfg.get_current_cfg();
    func = cfg.clib.set_src_info_NCAT
