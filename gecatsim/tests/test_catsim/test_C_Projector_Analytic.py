from gecatsim.pyfiles.C_Projector_Analytic import C_Projector_Analytic
import numpy as np
...
class Test_C_Projector_Analytic(unittest.TestCase):
    ...
    def test_C_Projector_Analytic_calls_clib_Projector(self):
        ...
        cfg.clib.Projector = MagicMock()
        cfg.clib.Projector_threaded = MagicMock()
        C_Projector_Analytic(cfg,0,0)
        if os.name == "nt":
            assert cfg.clib.Projector.call_count == 1
            assert cfg.clib.Projector_threaded.call_count == 0
        else:
            assert cfg.clib.Projector.call_count == 0
            assert cfg.clib.Projector_threaded.call_count == 1
