...
class TestCatsimfilter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.cfg.flat_filters = ['filter1', 'filter2']
        self.cfg.spectrum_filename = 'tungsten_tar7_120_unfilt.dat'
        self.cfg.spectrum_filtered_string = '_test'
        self.cfg.det = MagicMock()
        self.cfg.det.gammas = np.array([0.1, 0.2, 0.3])
        self.cfg.det.alphas = np.array([0.1, 0.2, 0.3])
        self.cfg.det.totalNumCells = 3
        self.cfg.spec = MagicMock()
        self.cfg.spec.nEbin = 3
        self.cfg.protocol = MagicMock()
        self.cfg.protocol.flatFilter = ['material1', 0.1, 'material2', 0.2]
        self.cfg.src = MagicMock()
        self.cfg.src.filterTrans = np.ones((3, 3))
    ...
    def test_catsimfilter(self, mock_open, mock_get_mu, mock_read_material_file, mock_spectrum_read, mock_listdir, mock_isfile, mock_isdir, mock_exists):
