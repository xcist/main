...
#endif
void pd2dbpflat(float detUCenter, int detUCount, float detUSize,
  ...
  /*
    This should be very close to recipAlpha, but we'll calculate it seperately
    anyway.
  */
  SDDOverDelU = SDD/detUSize;
